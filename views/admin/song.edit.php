...
<div id="main" class="">
    <h2 class="text-center mb-4">Chỉnh sửa bài hát: <?= htmlspecialchars($song['title']) ?></h2>
    ...
    <form id="editSongForm" method="POST" action="/song/edit" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <div class="form-text">Hiện tại: <a href="<?= htmlspecialchars($song['file_url']) ?>" target="_blank"><?= htmlspecialchars(basename($song['file_url'])) ?></a></div>
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="form-text">Hiện tại: <a href="<?= htmlspecialchars($song['cover_url']) ?>" target="_blank"><?= htmlspecialchars(basename($song['cover_url'])) ?></a></div>
        </div>
